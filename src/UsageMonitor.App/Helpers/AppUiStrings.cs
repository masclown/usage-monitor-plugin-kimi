...
public static class AppUiStrings
{
    ...
    private static readonly Dictionary<string, string> ZhCn = new()
    {
        ...
        ["settings.refresh.unit.minutes"] = "分钟",
        ["settings.refresh.hint"] = "建议 1-60 分钟",
        ["settings.autostart"] = "开机自动启动",
        ["settings.tooltip.showFieldName"] = "图表 tooltip 数据前包含字段名称",
        ["settings.tooltip.showFieldName.hint"] = "开启后 tooltip 显示为“用量 197.42M”，关闭后仅显示“197.42M”",
        ["settings.chart.showTitle"] = "卡片图表显示标题",
        ["settings.chart.showTitle.hint"] = "开启后每个图表上方显示图表名称（如“每日消费”）",
    ...
    private static readonly Dictionary<string, string> EnUs = new()
    {
        ...
        ["settings.refresh.unit.minutes"] = "min",
        ["settings.refresh.hint"] = "Recommended 1-60 min",
        ["settings.autostart"] = "Start on system boot",
        ["settings.tooltip.showFieldName"] = "Include field name before tooltip value",
        ["settings.tooltip.showFieldName.hint"] = "On: '用量 197.42M'; Off: '197.42M'",
        ["settings.chart.showTitle"] = "Show chart titles on cards",
        ["settings.chart.showTitle.hint"] = "On: display chart name (e.g. 'Daily Cost') above each chart",
